...
public class PdfServiceImpl implements PdfService {
	...
	public String generateDocumentPdf(Document document, Integer versionNumber) {
		...
		try {
			...
			Paragraph heading = new Paragraph("DOCUMENT APPROVAL SYSTEM").simulateBold().setFontSize(20)
					.setTextAlignment(TextAlignment.CENTER);

			pdfDocument.add(heading);

			Paragraph subHeading = new Paragraph("Office Document Clearance & Approval Workflow").setFontSize(11)
			...
			pdfDocument.add(new Paragraph(document.getDocumentContent()).setFontSize(12).setMultipliedLeading(1.5f));
			...
			Paragraph footer = new Paragraph("Generated by Document Approval System").setFontSize(10).simulateItalic()
					.setTextAlignment(TextAlignment.CENTER);

			pdfDocument.add(footer);

			Paragraph version = new Paragraph("Version : " + versionNumber).setFontSize(10)
					.setTextAlignment(TextAlignment.CENTER);
